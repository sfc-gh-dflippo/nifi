...
/**
 * Unit tests for PostgreSQLBulkExport processor.
...
public class PostgreSQLBulkExportTest {
    ...
    public void testProcessorValidationWithSourceTable() {
        ...
        boolean hasBasicPropertyErrors = results.stream()
            .anyMatch(result -> 
                result.getSubject().equals("Source Table") || 
    ...
    public void testProcessorValidationWithCustomQuery() {
        ...
        boolean hasBasicPropertyErrors = results.stream()
            .anyMatch(result -> 
                result.getSubject().equals("Custom Query") || 
                result.getSubject().equals("Data Format"));
        assertFalse(hasBasicPropertyErrors, "Should not have basic property validation errors");
    }
    ...
    public void testProcessorInputRequirement() {
        ...
        assertEquals(org.apache.nifi.annotation.behavior.InputRequirement.Requirement.INPUT_FORBIDDEN, 
                     inputReq.value());
    }
    ...
    public void testProcessorStateful() {
        ...
        org.apache.nifi.annotation.behavior.Stateful stateful = 
            processor.getClass().getAnnotation(org.apache.nifi.annotation.behavior.Stateful.class);
    ...
    public void testProcessorWritesAttributes() {
        ...
        boolean hasMimeTypeAttr = java.util.Arrays.stream(writesAttrs.value())
            .anyMatch(attr -> "mime.type".equals(attr.attribute()));
    ...
    public void testProcessorDefaultSchedule() {
        ...
        org.apache.nifi.annotation.configuration.DefaultSchedule defaultSchedule = 
            processor.getClass().getAnnotation(org.apache.nifi.annotation.configuration.DefaultSchedule.class);
